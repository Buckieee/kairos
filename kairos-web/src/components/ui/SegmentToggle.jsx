        ...
        >
            {segments.map((seg) => (
                <button
                    ...
                    aria-controls={`track-panel-${seg.id}`}
                    id={`track-tab-${seg.id}`}
                    className="relative rounded-full px-5 py-2 text-sm font-medium transition-colors duration-200 cursor-pointer focus:outline-none focus-visible:outline-2 focus-visible:outline-accent focus-visible:outline-offset-2"
                >
                    {active === seg.id && (
                        <motion.span
                            layoutId="segment-bg"
